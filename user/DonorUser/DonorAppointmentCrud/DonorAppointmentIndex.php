...
$donor_query = mysqli_query($conn, "SELECT donor_id 
                                    FROM donors_users 
...
if (!$donor_data) {
    echo "<div class='container'><div class='message error'>Donor record not found.</div></div>";
...
<div class="container">
    ...
    <div class="top-bar">
        ...
        <div>
            <a href="../DonorDashboard.php" class="back-btn">← Back to Dashboard</a>
            <a href="DonorAppointmentCreate.php" class="create-btn">
                + Create Appointment
            </a>
        </div>
    </div>
